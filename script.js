...
function toggleBio3(bioId, button) {
    const bio3 = document.getElementById(bioId);

    bio3.classList.toggle("show");
    // Toggle between showing and hiding the bio section
    if (bio3.classList.contains("show")) {
        button.textContent = "Hide Bio";
    } else {
        button.textContent = "Meet Sree";
    }
}
